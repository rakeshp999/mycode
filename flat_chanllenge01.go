...
Write a program that reads (and displays) the top n lines of a text file.
Both the file to be read, and the number of lines displayed should be passed as arguments.
