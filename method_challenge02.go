...
Create a struct type, Virtmach, to track information about virtual machines. 
Your record can track whatever you'd like, but values like ip, hostname, diskgb, ram, 
could all be possible values. Create at least two (2) methods that allow you to 
interact with your struct. If you come up with your own working solution, push it to your SCM (GitHub), 
